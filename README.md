...
```
1. Click Connect to localhost:27017
2. Click open mongo db shell
```
5. Creating a new database
```
1. click + icon near localhost
...
```
on Shell
1. Switch to the database using command > use sparta
2. Create collection using command > db.createCollection("institute")
```
